...
select papel,cotacao,pl,pvp,dividend_yield from acoes where pvp >=0.12;

select * from acoes where patrimonio_liquido >=100000000000;

select papel,cotacao,pl,dividend_yield,patrimonio_liquido from acoes where pvp >=100000000000;
